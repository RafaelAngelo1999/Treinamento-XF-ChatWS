...
namespace Chat.ViewModel
{
	...
	public partial class MensagemViewModel : INotifyPropertyChanged
    {
        private StackLayout SL;
        private Chat.Model.Chat chat;
        ...
        {
            var layout = new StackLayout() { Padding = 5, BackgroundColor = Color.FromHex("#B22222"), HorizontalOptions = LayoutOptions.End };
        ...
        {
            var labelNome = new Label() { Text = mensagem.usuario.nome, FontSize = 10, TextColor = Color.FromHex("#B22222") };
            var labelMensagem = new Label()  { Text = mensagem.mensagem, TextColor = Color.FromHex("#B22222") };

            var SL = new StackLayout();
            SL.Children.Add(labelNome);
            SL.Children.Add(labelMensagem);
            var frame = new Frame() { BorderColor = Color.FromHex("#B22222"), CornerRadius = 4, HorizontalOptions = LayoutOptions.Start };
            frame.Content = SL;
            return frame;
        }
        ...
        public MensagemViewModel (Chat.Model.Chat chat, StackLayout SLMensagemContainer)
		{
            this.chat = chat;
        ...
        {
            Mensagens = ServiceWS.GetMensagemChats(chat);
        }
